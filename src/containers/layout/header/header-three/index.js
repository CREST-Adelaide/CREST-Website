                    ...
                    <Container>
                        <Row>
                            <Col lg={12}>
                                <HeaderMain top>
                                    <HeaderCol left>
                                        <a href="https://www.crest-centre.net/encrypted-traffic"><Text color={transparent ? '#fff' : 'textColor'} {...noticeStyle}><strong>Guest Talk: Analytics over Encrypted Traffic and Defences</strong></Text></a>
